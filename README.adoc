...
= GBIF Global Nodes Courses

This is the the GBIF Global Nodes courses site.

During development, it is visible at https://globalnodes.gbif-uat.org/

NOTE: This file is documenting the Global Nodes course site system, it's not shown on https://globalnodes.gbif-uat.org/.
