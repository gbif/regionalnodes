...
At the conclusion of the activity, some groups will selected to present their mapping.
====
...
* My staff get trained to publish using DwC-Archive, why should we change now?
