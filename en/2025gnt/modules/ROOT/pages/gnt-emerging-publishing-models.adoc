...
If you'd like to conduct this exercise at your own institution, you can xref:attachment$SurveyingTheViridianForest-DwC-DP-Activity.zip[download all the materials] (10.5 MB) for printing on A3 paper.
====
