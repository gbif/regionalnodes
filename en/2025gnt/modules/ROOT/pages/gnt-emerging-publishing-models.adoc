...
At the conclusion of the activity, groups will be asked to https://flic.kr/s/aHBqjCxcYg[present their mappings^].

https://dwcdp-ipt.gbif-test.org/resource?r=viridian-forest-survey[Viridian Forest Survey of Flying Bug-type Pokémon^] published on the DwC-DP test IPT.
====
