...
. Watch pre-recorded presentations from GBIF Switzerland, the Specify Collections Consortium, and the Botanischer Garten und Botanisches Museum. All three groups have been working on the data model. Read through slides contributed by other nodes in preparation for this session and consider xref:sharingexperience.adoc[sharing slides] on your node’s experience with work to expand GBIF’s data model
