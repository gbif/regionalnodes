...
* Describe the Convention on Biological Diversity (CBD)
* Describe the different components of the Kunming-Montreal Global Biodiversity Framework (GBF) and the links between the framework and primary biodiversity data.
* Describe global, national and regional targets and their relevance across GBIF.
* Identify Convention on Biological Diversity (CBD) contacts and National Biodiversity Strategy and Action Plan (NBSAP) within your country.
