...
//image::ROOT::PriorityTargets.png[]

&nbsp;

//image::ROOT::NodeStaff.png[]

&nbsp;

//image::ROOT::CurrentNBSAP.png[]

&nbsp;

//image::ROOT::UpdatingNBSAP.png[]
...
++++
<div class="responsive-slides">
  <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vRZldvkIDnhfW79cdAI51oxncDQUFMd4-XqbrjpH2E1jTgbbscOC-lYGhwDvi3UBQ/embed?start=false&loop=false" frameborder="0" allowfullscreen="true"></iframe>
</div>
++++
