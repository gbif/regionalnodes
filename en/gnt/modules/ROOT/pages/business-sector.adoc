...
[NOTE.objectives]
In this module, you will learn about the business sector, specifically:
...
[NOTE.presentation]
This presentation provides and introduction to the business sector, some key sustainabiltiy frameworks that are shaping the work of this sector and initiatives that GBIF is taking with this sector.  
...
[NOTE.activity]
For this activity, you will be place in one of three groups and with other group members will compile needs and compare them with benefits and services offered by nodes. Review the exercise instructions below.
...
[NOTE.presentation]
This presentation focuses key aspects to allow your Node to begin or better engage with the business sector in your country. 
...
[NOTE.assignment]
Use this action plan to document your Node priorities for engaging the business sector in your country.
