...
* Describe successful examples of raising Node visibility.
* Identify active users of GBIF-mediated data and authors of papers.
* Identify community engagement tools and resources.
* Develop a strategy to engage the research community and raise the visibility of GBIF and your Node within your country and with this community.
...
[NOTE.presentation]
This presentation provides and introduction to GBIF as a research infrastructure
...
. Using the filters on the left, select your country for the Country or area of researcher. Note the number of data use results.
. Clear your filter for Country or area of researcher.
. Using the filters on the lect, select your country for Country or area of coverage. Note the number of data use results.
. Select one of the data use results. Examine the information provided. Do you know any of the researchers?
...
[NOTE.presentation]
This presentation focuses on experiences of raising the visibility of GBIF and the Node in Belgium
